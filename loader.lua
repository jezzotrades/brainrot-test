...
task.spawn(function()
    while task.wait(0.1) do
        if enabled then
            ...
            -- NEW CHECK: detect if Brainrot is in your hand (anywhere in your character)
            if brainrot and player.Character then
                holding = brainrot:IsDescendantOf(player.Character)
            end
